...
function main(){
    System.start({title: "CornerContour Kha Graphics4 Test", width: 1024, height: 768, framebuffer:{samplesPerPixel: 4} }, function (_) {
